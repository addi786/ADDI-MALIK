...
<div>
	<div class="header" style="width: 88.5%;margin-left: 70px;height: 200px;background:#8B0000;">
		<form align="right"> &nbsp;&nbsp;&nbsp;<input style="size: 20px;" type="text" name="search_box" placeholder="Search Movies">
		...
		<input type="submit"  value="Show All Data"  name="AllData">
									...
									<?php 
										...
										if (isset($_GET['submit'])) {
											...
											$query = "SELECT * FROM bollywood WHERE name LIKE '%".$search_box."%'";
										}
										...
										while ($row = mysqli_fetch_array($run)) {
											...
											<div style="border:5px solid #8B0000 ;cursor: hand;margin-left:70px;margin-top:10px ;float: left; background:#8B0000; height: 210px;  width: 300px">
												<img src="<?php  echo $m_image; ?>" style="width: 300px;height: 170px;">
